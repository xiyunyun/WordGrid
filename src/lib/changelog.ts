...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "2026-07-20",
    items: [
      "重新设计 8 个非默认主题：羊皮古卷、林间书桌、子夜静读、远洋日志、玫瑰信笺、炭笔素描、紫藤诗笺、落日手记",
      "每个主题搭配独特的背景纹理质感（径向光晕 + 图案层 + 噪点），不再只是简单换色：子夜静读有星点、远洋日志有波浪、炭笔素描有排线、紫藤诗笺有墨韵水痕等",
      "主题选择面板预览卡片升级：从单纯色板改为实际纹理预览，所见即所得",
    ],
  },
  {
    version: "2.2.0",
  ...
  },
  {
    ...
    date: "2026-07-20",
    items: [
      "随笔导航位置调整：从「统计」与「关于」之间移至「生词本」与「积木造文」之间",
      "修复进入随笔页时强制弹出添加菜单的问题：现仅点击 Add 按钮才会唤起抽屉",
      "统一名称：每日网格页标题「词汇档案」改为「每日网格」，随笔页「句子便签」改为「时光随笔」",
      "修复红点不实时更新问题：导航生词本红点与每日网格 Due Today 提示改为「到期词 ∪ 当日新加未掌握词」合并数量，当日新增 10 词时红点会立即从 5 变 15",
      "修复随笔瀑布流长句超出板块的问题：卡片正文 / 翻译 / 笔记添加 break-words + min-w-0，超长无空格字符串可自适应换行",
    ],
  },
  {
    version: "2.1.0",
    date: "2026-07-20",
    items: [
      "新增「随笔」主页面（第六个导航项）：用于摘录喜欢的句子和翻译，按日期分组，瀑布流卡片布局（移动端 1 列、平板 2 列、桌面 3 列），卡片高度随内容自适应不被截断",
      "随笔卡片只保留播音 / 编辑 / 删除三个按钮，字段精简为正文 + 翻译 + 日期 + 笔记，无词性音标；随笔页支持一键展开 / 收起全部、最新 / 最早排序切换",
      "随笔页点击全局 Add 按钮自动唤起添加随笔抽屉，其他页面仍打开添加单词抽屉",
      "修复词汇档案右上角「待复习词」弹窗与生词本「自我检测」逻辑不一致问题：现统一为「到期词 ∪ 当日新词」合并列表，为空时回退到全部生词",
    ],
  },
  {
    version: "2.0.0",
