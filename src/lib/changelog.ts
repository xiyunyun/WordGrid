...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: "2026-08-06",
    items: [
      "新增账号注册功能：用户可以直接在登录页注册账号，无需管理员手动添加",
      "新增密钥解锁机制：注册账号默认可用单词本、复习等本地功能；语音朗读、AI 文章生成、云存档需要输入密钥解锁后才能使用，密钥由管理员提供",
      "新增游客登录：可直接以游客身份进入，仅限使用本地功能，不含语音、AI、云存档",
      "修复数据大小显示不准确：关于页面显示的数据大小现在与实际下载文件大小一致",
      "修复数据导出遗漏：日期备注数据现在会被完整包含在导出文件中",
    ],
  },
  {
    version: "3.4.0",
