...
export default function DictionaryModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] flex animate-fade-in items-center justify-center p-4">
      ...
      {/* 弹窗 */}
      <div className="relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-lg border border-ink/15 bg-paper-card shadow-deep-always animate-fade-in">
        {/* 头部 */}
