    ...
    <div className="space-y-6">
      ...
      <section className="rounded-md border border-ink/15 bg-paper-card p-4 md:p-6 hover:shadow-paper-hover">
        ...
        <p className="font-body text-sm leading-relaxed text-ink-soft">
          ...
          它将每日学习的单词以网格形式呈现，配合七阶段智能复习计划，
          帮助你科学抗遗忘。每日网格支持批量导入、多选删除与日历筛选，
          让词汇管理井然有序；生词本提供待复习红点、熟练度统计与一键导出，
          支持按日期、掌握状态灵活筛选。自我检测卡片流转，答错自动重问，
          进度按日持久化、跨设备同步；笔记弹窗可直接查看与编辑，批量导入
          时支持分号换行，轻松整理谐音、近似词、派生词与例句。还内置
          积木造文、随笔写作、AI 文章生成与阅读理解等延伸能力，
          云端实时同步让你在多设备间无缝切换。
          <br />
          <br />
          【更多功能锐意开发中，有好的建议随时联系开发者，QQ：1619947679，微信：r1619947679，邮箱：1619947679@qq.com】
        </p>
      </section>
